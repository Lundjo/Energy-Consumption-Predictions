...
class CustomPreparer:
    ...
    def create_dataset(self, dataset, look_back):
        ...
        for i in range(len(dataset)-1):
            a = numpy.delete(dataset[i, :], self.predictor_column_no)  # Uklanjamo kolonu 13 iz ulaza
            dataX.append(a)
            dataY.append(dataset[i, self.predictor_column_no])  # Ciljna kolona je kolona 13
